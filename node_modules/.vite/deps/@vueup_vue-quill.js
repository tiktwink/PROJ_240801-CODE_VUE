  ...
  "node_modules/quill-delta/dist/Delta.js"(exports, module) {
    ...
    var Delta2 = (
      ...
      function() {
        ...
        Delta3.prototype.insert = function(arg, attributes) {
          var newOp = {};
        ...
        Delta3.prototype.delete = function(length) {
          if (length <= 0) {
            return this;
          }
          return this.push({ delete: length });
        };
        Delta3.prototype.retain = function(length, attributes) {
          if (length <= 0) {
            return this;
          }
          var newOp = { retain: length };
        ...
        Delta3.prototype.push = function(newOp) {
          var index = this.ops.length;
          var lastOp = this.ops[index - 1];
        ...
        Delta3.prototype.chop = function() {
          var lastOp = this.ops[this.ops.length - 1];
          if (lastOp && lastOp.retain && !lastOp.attributes) {
            this.ops.pop();
          }
        ...
        Delta3.prototype.filter = function(predicate) {
          return this.ops.filter(predicate);
        };
        Delta3.prototype.forEach = function(predicate) {
          this.ops.forEach(predicate);
        };
        Delta3.prototype.map = function(predicate) {
          return this.ops.map(predicate);
        };
        Delta3.prototype.partition = function(predicate) {
          var passed = [];
          var failed = [];
        ...
        Delta3.prototype.reduce = function(predicate, initialValue) {
          return this.ops.reduce(predicate, initialValue);
        };
        Delta3.prototype.changeLength = function() {
          return this.reduce(function(length, elem) {
            if (elem.insert) {
        ...
        Delta3.prototype.length = function() {
          return this.reduce(function(length, elem) {
            return length + Op_1.default.length(elem);
          }, 0);
        };
        Delta3.prototype.slice = function(start, end) {
          if (start === void 0) {
            start = 0;
          }
          if (end === void 0) {
          ...
          return new Delta3(ops);
        };
        Delta3.prototype.compose = function(other) {
            ...
            if (otherIter.peekType() === "insert") {
              ...
              if (typeof otherOp.retain === "number") {
                ...
                if (!otherIter.hasNext() && lodash_isequal_1.default(delta.ops[delta.ops.length - 1], newOp)) {
                  var rest = new Delta3(thisIter.rest());
                  return delta.concat(rest).chop();
                }
              } else if (typeof otherOp.delete === "number" && typeof thisOp.retain === "number") {
                delta.push(otherOp);
        ...
        Delta3.prototype.concat = function(other) {
          var delta = new Delta3(this.ops.slice());
          if (other.ops.length > 0) {
            delta.push(other.ops[0]);
            delta.ops = delta.ops.concat(other.ops.slice(1));
          }
        ...
        Delta3.prototype.diff = function(other, cursor) {
          if (this.ops === other.ops) {
            return new Delta3();
          }
        ...
        Delta3.prototype.eachLine = function(predicate, newline) {
          if (newline === void 0) {
            newline = "\n";
          }
          var iter = Op_1.default.iterator(this.ops);
        ...
        Delta3.prototype.invert = function(base) {
          var inverted = new Delta3();
        ...
        Delta3.prototype.transform = function(arg, priority) {
          if (priority === void 0) {
            priority = false;
          }
          priority = !!priority;
        ...
        Delta3.prototype.transformPosition = function(index, priority) {
          if (priority === void 0) {
            priority = false;
          }
          priority = !!priority;
        ...
        Delta3.Op = Op_1.default;
        Delta3.AttributeMap = AttributeMap_1.default;
        return Delta3;
      }()
    );
