...
var _Slider = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var COMPONENT_NAME = hooks_useConfig.usePrefixClass("slider");
    ...
    var firstValue = Vue.ref(slider_util_common.formatSliderValue(sliderValue.value, "first"));
    var secondValue = Vue.ref(slider_util_common.formatSliderValue(sliderValue.value, "second"));
    ...
    var setValues = function setValues(value2) {
      ...
      if (props2.range && isArray__default["default"](value2)) {
    ...
    var init = function init() {
      var valuetext;
      if (props2.range) {
        if (isArray__default["default"](sliderValue.value)) {
        ...
        if (!isNumber__default["default"](sliderValue.value)) {
    ...
    Vue.watch(function () {
      ...
      if (isArray__default["default"](newVal) && props2.range) {
    ...
    var _toRefs2 = Vue.toRefs(props2),
      ...
      max = _toRefs2.max,
      step = _toRefs2.step;
    Vue.provide(slider_util_constants.sliderPropsInjectKey, Vue.reactive({
      min: min,
      max: max,
      step: step,
      dragging: dragging,
    ...
    return function () {
      return Vue.createVNode("div", {
        ...
        return Vue.createVNode("div", {
          ...
          "key": key,
          "style": slider_util_common.getStopStyle(item, vertical.value)
        }, null);
