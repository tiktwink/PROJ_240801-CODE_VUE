...
var _common_js_tree_treeNode = require('./tree-node.js');
...
var TreeStore = /*#__PURE__*/function () {
  ...
  return _createClass__default["default"](TreeStore, [{
    ...
    value: function getNode(item) {
      ...
      } else if (item instanceof _common_js_tree_treeNode.TreeNode) {
    ...
    value: function append(list) {
      ...
      list.forEach(function (item) {
        var node = new _common_js_tree_treeNode.TreeNode(_this, item);
    ...
    value: function parseNodeData(para, item) {
      ...
      if (isString__default["default"](para) || isNumber__default["default"](para)) {
        ...
        data = item;
      } else if (para instanceof _common_js_tree_treeNode.TreeNode) {
        if (item) {
          node = para;
          data = item;
        } else {
    ...
    value: function appendNodes(para, item) {
      ...
      if (spec.data) {
        if (!spec.node) {
          if (spec.data instanceof _common_js_tree_treeNode.TreeNode) {
    ...
    value: function updated(node) {
      ...
      if (node) {
        updatedMap.set(node[_common_js_tree_treeNode.privateKey], "changed");
      } else {
        this.getNodes().forEach(function (itemNode) {
          updatedMap.set(itemNode[_common_js_tree_treeNode.privateKey], "changed");
        });
      }
