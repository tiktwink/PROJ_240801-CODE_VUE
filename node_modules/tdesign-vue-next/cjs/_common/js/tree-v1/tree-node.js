...
var _common_js_treeV1_treeNodeModel = require('./tree-node-model.js');
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    var _this = this;
    _classCallCheck__default["default"](this, TreeNode);
    _defineProperty__default["default"](this, "tree", void 0);
    ...
    _defineProperty__default["default"](this, "vmIsLeaf", void 0);
    _defineProperty__default["default"](this, "vmIsFirst", void 0);
    _defineProperty__default["default"](this, "vmIsLast", void 0);
    _defineProperty__default["default"](this, "vmIsRest", void 0);
    _defineProperty__default["default"](this, "vmIsLocked", void 0);
    _defineProperty__default["default"](this, "expanded", void 0);
    _defineProperty__default["default"](this, "expandMutex", void 0);
    _defineProperty__default["default"](this, "actived", void 0);
    _defineProperty__default["default"](this, "activable", void 0);
    _defineProperty__default["default"](this, "checkable", void 0);
    _defineProperty__default["default"](this, "vmCheckable", void 0);
    _defineProperty__default["default"](this, "checked", void 0);
    _defineProperty__default["default"](this, "indeterminate", void 0);
    _defineProperty__default["default"](this, "disabled", void 0);
    _defineProperty__default["default"](this, "draggable", void 0);
    _defineProperty__default["default"](this, "visible", void 0);
    _defineProperty__default["default"](this, "level", void 0);
    _defineProperty__default["default"](this, "loading", void 0);
    this.data = data;
    this.tree = tree;
    ...
    this.draggable = null;
    this[privateKey] = uniqueId__default["default"](prefix);
    this.value = isNil__default["default"](get__default["default"](data, propValue)) ? this[privateKey] : get__default["default"](data, propValue);
    var nodeMap = tree.nodeMap,
      privateMap = tree.privateMap;
    if (nodeMap.get(this.value)) {
      _common_js_log_log["default"].warn("Tree", "Dulplicate value: ".concat(this.value));
    }
    nodeMap.set(this.value, this);
    privateMap.set(this[privateKey], this);
    this.label = get__default["default"](data, propLabel) || "";
    this.disabled = get__default["default"](data, propsDisabled);
  ...
  return _createClass__default["default"](TreeNode, [{
    key: "initChecked",
    ...
    value: function initExpanded() {
      ...
      var config = tree.config;
      if (isNumber__default["default"](config.expandLevel) && this.getLevel() < config.expandLevel) {
    ...
    value: function append(data) {
      ...
      if (!Array.isArray(data)) {
        ...
        list.push.apply(list, _toConsumableArray__default["default"](data));
      }
      if (list.length <= 0) {
        return;
      }
    ...
    value: function appendTo(tree, parent, index) {
      ...
      var targetIndex = -1;
      if (isNumber__default["default"](index)) {
        targetIndex = index;
      }
    ...
    key: "loadChildren",
    value: function () {
      var _loadChildren = _asyncToGenerator__default["default"]( /*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
        var config, list;
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              config = get__default["default"](this, "tree.config") || {};
              if (!(this.children === true && !this.loading)) {
                _context.next = 13;
                break;
              }
              if (!isFunction__default["default"](config.load)) {
                _context.next = 13;
                break;
              }
              this.loading = true;
    ...
    value: function getChildren(deep) {
      ...
      } else if (isBoolean__default["default"](children)) {
    ...
    value: function isDraggable() {
      var state = !!get__default["default"](this, "tree.config.draggable");
    ...
    value: function isExpandMutex() {
      var state = !!get__default["default"](this, "tree.config.expandMutex");
    ...
    value: function isActivable() {
      var state = !!get__default["default"](this, "tree.config.activable");
    ...
    value: function isCheckable() {
      var state = !!get__default["default"](this, "tree.config.checkable");
    ...
    value: function isIndeterminate() {
      ...
      var indeterminate = children.some(function (node) {
        ...
        if (isNull__default["default"](childChecked)) {
    ...
    value: function getModel() {
      ...
      if (!model) {
        model = _common_js_treeV1_treeNodeModel.createNodeModel(this);
        this.model = model;
      }
      _common_js_treeV1_treeNodeModel.updateNodeModel(model, this);
      return model;
    }
  }]);
}();
...
exports.setableProps = setableProps;
exports.setableStatus = setableStatus;
exports.syncableProps = syncableProps;
