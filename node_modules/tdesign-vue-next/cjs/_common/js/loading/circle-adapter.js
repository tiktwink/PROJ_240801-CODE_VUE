...
var _common_js_utils_setStyle = require('../utils/set-style.js');
...
function circleAdapter(circleElem) {
  ...
  if (color && _common_js_utils_helper.getIEVersion() > 11) {
    var matched = color.match(/[\d.]+/g);
    var endColor = matched ? "rgba(".concat(matched[0], ", ").concat(matched[1], ", ").concat(matched[2], ", 0)") : "";
    _common_js_utils_setStyle["default"](circleElem, _objectSpread(_objectSpread({}, basicStyle), {}, {
