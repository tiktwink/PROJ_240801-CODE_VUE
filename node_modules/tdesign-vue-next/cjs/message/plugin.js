...
var Vue = require('vue');
var message_messageList = require('./messageList.js');
...
var MessageFunction = function MessageFunction(props) {
  ...
  var attachDom = utils_dom.getAttach(attach);
  ...
  if (!p) {
    ...
    var instance = Vue.createApp(message_messageList.MessageList, {
...
var showThemeMessage = function showThemeMessage(theme, params, duration) {
  ...
  if (isString__default["default"](params)) {
    options.content = params;
  } else if (isObject__default["default"](params) && !(params instanceof Array)) {
