...
function userController(props, state) {
  ...
  var configData = Vue.computed(function () {
    ...
    if (isBoolean__default["default"](controllerConfig)) {
  ...
  function emitControllerChange() {
    Vue.nextTick(function () {
      isFunction__default["default"](props.onControllerChange) && props.onControllerChange(_objectSpread({}, options.value));
    });
  }
  return {
    options: options,
