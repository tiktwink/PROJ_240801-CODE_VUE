  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      var classes = Vue.computed(function () {
        return ["".concat(name.value, "__inner"), _defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"](_defineProperty__default["default"]({}, "".concat(prefix.value, "-is-").concat(props2.status), props2.status), STATUS.value.disabled, disabled.value), STATUS.value.focused, focused.value), "".concat(prefix.value, "-resize-none"), _typeof__default["default"](props2.autosize) === "object"), "narrow-scrollbar"];
      });
