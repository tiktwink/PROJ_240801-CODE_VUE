...
var _StepItem = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var _useConfig = configProvider_useConfig.useConfig("steps"),
    ...
    var COMPONENT_NAME = hooks_useConfig.usePrefixClass("steps-item");
      ...
      if (stepsProps.theme === "default") {
        ...
        switch (props2.status) {
          case "finish":
            ...
            break;
          case "error":
            if (isFunction__default["default"](globalConfig.value.errorIcon)) {
