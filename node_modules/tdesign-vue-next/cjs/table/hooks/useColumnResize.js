...
function useColumnResize(params) {
  ...
  var getMinMaxColWidth = function getMinMaxColWidth(targetCol) {
    ...
    var propMinWidth = isNumber__default["default"](targetCol.minWidth) ? targetCol.minWidth : parseInt(targetCol.minWidth || "0", 10);
    return {
  ...
  var onColumnMousedown = function onColumnMousedown(e, col, index) {
    ...
    var onDragEnd = function onDragEnd() {
      ...
      utils_dom.off(document, "mouseup", onDragEnd);
      utils_dom.off(document, "mousemove", onDragOver);
    ...
    utils_dom.on(document, "mouseup", onDragEnd);
    utils_dom.on(document, "mousemove", onDragOver);
