...
function mergeDefaultProps(props) {
  var options = merge__default["default"]({
    fullscreen: false,
    attach: "body",
    loading: true,
...
function createLoading(props) {
  ...
  var attach = utils_dom.getAttach(mergedProps.fullscreen ? "body" : mergedProps.attach);
  ...
  var prefixClass = hooks_useConfig.usePrefixClass("loading");
  ...
  if (lockFullscreen) {
    utils_dom.addClass(document.body, lockClass.value);
  }
  if (attach) {
