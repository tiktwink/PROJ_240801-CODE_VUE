...
var _Statistic = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var COMPONENT_NAME = hooks_useConfig.usePrefixClass("statistic");
    var renderTNodeJSX = hooks_tnode.useTNodeJSX();
    var _useGlobalIcon = hooks_useGlobalIcon.useGlobalIcon({
        ArrowTriangleUpFilledIcon: tdesignIconsVueNext.ArrowTriangleUpFilledIcon,
        ArrowTriangleDownFilledIcon: tdesignIconsVueNext.ArrowTriangleDownFilledIcon
      }),
    ...
    var numberValue = Vue.computed(function () {
      return isNumber__default["default"](props2.value) ? props2.value : 0;
    });
    ...
    var formatValue = Vue.computed(function () {
      var formatValue2 = innerValue.value;
      var decimalPlaces = props2.decimalPlaces,
        separator = props2.separator;
      if (isFunction__default["default"](props2.format)) {
        return props2.format(formatValue2);
      }
      var options = {
      ...
      formatValue2 = formatValue2.toLocaleString(void 0, options).replace(/,|，/g, separator);
      return formatValue2;
    });
    var contentStyle = Vue.computed(function () {
      var color = props2.color;
      return {
        color: _common_js_statistic_utils.COLOR_MAP[color] || color
      };
    });
    Vue.watch(function () {
