...
function getSingleContent(cascaderContext) {
  ...
  if (isArray__default["default"](value)) return "";
...
function getMultipleContent(cascaderContext) {
  var value = cascaderContext.value,
    ...
    showAllLevels = cascaderContext.showAllLevels;
  if (!multiple) return [];
  if (multiple && !isArray__default["default"](value)) return [];
  var node = treeStore && treeStore.getNodes(value);
  if (!node) return [];
...
var getTreeValue = function getTreeValue(value) {
  ...
  if (isArray__default["default"](value)) {
    if (value.length > 0 && isObject__default["default"](value[0])) {
...
function isEmptyValues(value) {
  if (isNumber__default["default"](value) && !isNaN(value)) return false;
  return isEmpty__default["default"](value);
}
function isValueInvalid(value, cascaderContext) {
  var multiple = cascaderContext.multiple,
    showAllLevels = cascaderContext.showAllLevels;
  return multiple && !isArray__default["default"](value) || !multiple && isArray__default["default"](value) && !showAllLevels;
}
