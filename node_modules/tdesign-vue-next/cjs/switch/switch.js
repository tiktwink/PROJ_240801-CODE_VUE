...
var _Switch = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var content = Vue.computed(function () {
      if (isFunction__default["default"](props2.label)) {
        return props2.label(Vue.h, {
          value: innerValue.value
        });
      }
      if (isString__default["default"](props2.label)) {
        return props2.label;
      }
      if (isArray__default["default"](props2.label) && props2.label.length) {
        var label = innerValue.value === activeValue.value ? props2.label[0] : props2.label[1];
        if (!label) return;
        if (isString__default["default"](label)) {
          return label;
        }
        if (isFunction__default["default"](label)) {
          return label(Vue.h);
        }
      }
      if (slots.label) {
