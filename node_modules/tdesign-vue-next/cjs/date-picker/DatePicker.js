...
var _DatePicker = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    Vue.watch(popupVisible, function (visible) {
      ...
      var dateValue = value.value ? _common_js_datePicker_utils.covertToDate(value.value, (_formatRef$value = formatRef.value) === null || _formatRef$value === void 0 ? void 0 : _formatRef$value.valueType) : value.value;
