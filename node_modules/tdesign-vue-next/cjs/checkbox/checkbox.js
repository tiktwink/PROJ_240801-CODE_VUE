...
var _Checkbox = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    if (props2.needRipple) {
      hooks_useRipple["default"](labelRef);
    }
    ...
    var checkboxGroupData = Vue.inject(checkbox_constants.CheckboxGroupInjectionKey, void 0);
    var tName = Vue.ref();
    Vue.watch(function () {
    ...
    var COMPONENT_NAME = hooks_useConfig.usePrefixClass("checkbox");
