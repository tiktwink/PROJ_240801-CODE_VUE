...
import { c as commonjsGlobal } from '../../../../_chunks/dep-437d10c6.mjs';
import { a as dayjs_min } from '../../../../_chunks/dep-0c808c2e.mjs';
...
(function (module, exports) {
  !function (e, o) {
    "object" == 'object' && "undefined" != 'object' ? module.exports = o(dayjs_min.exports) : "function" == typeof undefined && undefined.amd ? undefined(["dayjs"], o) : (e = "undefined" != typeof globalThis ? globalThis : e || self).dayjs_locale_it = o(e.dayjs);
...
var it_IT = {
  ...
  table: {
    ...
    loadingMoreText: "Clicca per caricare di pi\xF9",
  ...
  upload: {
    sizeLimitMessage: "La dimensione del file non pu\xF2 superare {sizeLimit}",
  ...
  form: {
    errorMessage: {
      ...
      max: "La lunghezza dei caratteri di ${name} non pu\xF2 superare i ${validate} caratteri",
      min: "La lunghezza dei caratteri di ${name} non pu\xF2 essere inferiore a ${validate} caratteri",
      len: "La lunghezza dei caratteri di ${name} deve essere ${validate}",
      "enum": "${name} pu\xF2 essere solo ${validate}, ecc.",
  ...
  image: {
    errorText: "L'immagine non pu\xF2 essere visualizzata",
...
//# sourceMappingURL=it_IT.mjs.map
