...
const Scrollbar = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        const rtlEnabledRef = (0, _mixins_1.useRtl)('Scrollbar', mergedRtlRef, mergedClsPrefixRef);
        // dom ref
        ...
        const cssVarsRef = (0, vue_1.computed)(() => {
            const { common: { cubicBezierEaseInOut }, self: { color, colorHover, height, width, borderRadius, railInsetHorizontal, railInsetVertical, railColor } } = themeRef.value;
            return {
                ...
                '--n-scrollbar-rail-inset-vertical': (rtlEnabledRef === null || rtlEnabledRef === void 0 ? void 0 : rtlEnabledRef.value)
                    ? (0, _utils_1.rtlInset)(railInsetVertical)
                    : railInsetVertical,
