...
import { type Filter, type OnUpdateValue, type Option, type OptionValue, type TransferRenderSourceLabel, type TransferRenderSourceList, type TransferRenderTargetLabel } from './interface';
export declare const transferProps: {
    ...
    readonly renderTargetList: PropType<TransferRenderSourceList>;
