...
<template>
  <div class="w-full h-full px-2">
    <div>
      <p class="font-bold text-xl mb-3 relative">查看答卷<span
          class="absolute left-[22rem] top-20 btn btn-ghost btn-sm ml-4 mb-2 font-normal border-none bg-white hover:bg-secondary"
          @click="resetImgWidth"><svg class="icon" height="16" p-id="3785" t="1713191560562" version="1.1"
          ...
          fill="#515151" p-id="3786"></path></svg>重置({{ imgWidth.toFixed(0) }}%)</span></p>
      ...
      <p class="text-[#999] mt-4 mb-2 text-sm pl-2">在
        <text class="text-info">图像</text>
        区域滑动鼠标滑轮放大(上滑)或缩小(下滑)图像
      </p>
      <p class="text-[#999] mt-0 mb-4 text-sm pl-2">在
