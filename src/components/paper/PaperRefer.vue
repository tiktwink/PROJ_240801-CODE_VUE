    ...
    <div class="relative">
      <p class="font-bold text-xl mb-3 relative">查看答案
        ...
        <svg v-if="appStore.sideOn&&appStore.sidePart==='paperreferupload'" class="icon" height="16" p-id="15557"
          ...
          <text v-if="appStore.sideOn&&appStore.sidePart==='paperreferupload'">取消导入</text>
      ...
      <div v-if="paper.hasUrlRefer===1" class="flex justify-center">
        <n-scrollbar id="scroll" class="border-none cursor-pointer"
          ...
          <div class="flex justify-center items-center bg-white rounded-lg w-full">
            <img :src="'http://'+paper.urlRefer" alt="答案图像"
