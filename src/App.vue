      ...
      <div class="min-h-full flex flex-col bg-white">
        <div class="bg-info pb-4 overflow-hidden"
          ...
          <ul class="menu p-4 w-56 min-w-56 text-base-content gap-y-3 my-1">
            ...
            <li :class="{'current':$route.name==='试卷管理'}" @click="appStore.title='试卷管理'">
            ...
            <li :class="{'current':$route.name==='日志管理'}" @click="appStore.title='日志管理'">
              <router-link to="/history">日志管理</router-link>
            </li>
          </ul>
